 ...
 * @param {Record<string, import('@sclera/sdk').default extends never ? never : unknown>} [serviceDataKeys]
 */
...
export function getActionsForDomain(haClient, domain) {
  ...
  const actions = builder ? builder(haClient) : [];
  actions.push(createGenericCallServiceAction(haClient, domain));
